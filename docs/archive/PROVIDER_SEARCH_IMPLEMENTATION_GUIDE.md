> **Archived — not actually completed**: this proposal was left "IN PROGRESS - Partial Implementation" in Nov 2025 (Phase 1 tasks 1.2/1.3 unchecked) and is **not** tracked in the current `COMPLETION_ROADMAP.md` — it appears abandoned/deprioritized rather than shipped. Kept for history; re-validate against current code before resuming any of this. Moved 2026-07-12.
