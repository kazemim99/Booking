...
### Performance Targets
- ⏱️ Search response time: less than 500ms (95th percentile)
- ⏱️ Distance calculation: less than 100ms for 1000 providers
- ⏱️ Full-text search: less than 200ms for large result sets
