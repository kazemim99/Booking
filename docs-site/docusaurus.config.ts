...
const config: Config = {
  ...
  tagline: 'Professional Service Booking Platform - Technical Documentation',
  ...
  presets: [
    [
      'classic',
      {
        ...
        blog: false, // Disable blog since we're focused on technical docs
        theme: {
  ...
  themeConfig: {
    ...
    prism: {
      ...
      additionalLanguages: ['csharp', 'bash', 'json', 'sql', 'docker', 'yaml', 'powershell'],
    },
