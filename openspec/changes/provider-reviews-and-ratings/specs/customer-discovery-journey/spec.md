...
#### Scenario: Sorting by rating excludes the unrated from the bottom-as-zero trap
- **WHEN** the user sorts results by rating and some providers have no published reviews
- **THEN** rated providers are ordered by their published-review average and unrated providers are not interleaved as zero-rated
