...
The persisted list of notifications a user can read in the app, with read-state and an unread count. Replaces
fire-and-forget real-time delivery that leaves nothing behind for a client that was offline.
