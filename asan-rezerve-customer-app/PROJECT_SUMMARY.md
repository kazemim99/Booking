# AsanRezerve Customer App - Project Summary

## What Has Been Built

A complete **Flutter mobile application** for AsanRezerve platform customers with:
...
The app connects to the AsanRezerve backend:
