# AsanRezerve Customer App - Setup Guide

Complete step-by-step guide to set up and run the AsanRezerve Customer App.
...
The app connects to the AsanRezerve backend. Update the base URL if needed:
