...
## Purpose
AsanRezerve Admin Panel is a Vue 3-based administrative dashboard for managing the AsanRezerve booking platform. It provides interfaces for managing users, providers, services, bookings, analytics, payments, and system settings.
...
## Domain Context
AsanRezerve is a microservices-based booking platform for service providers (salons, clinics, etc.). The admin panel connects to:
