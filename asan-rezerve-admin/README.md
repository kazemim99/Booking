# AsanRezerve Admin Panel

Professional admin panel for managing the AsanRezerve booking platform.
...
# View logs
docker-compose logs -f asanrezerve-admin
```
