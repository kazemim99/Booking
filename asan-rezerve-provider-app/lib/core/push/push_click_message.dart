...
///
/// The worker posts `{type: 'asanrezerve-push-open', data: {...the push's data...}}`. Keep the literal in step with it.
const String pushClickMessageType = 'asanrezerve-push-open';
