...
import 'package:asan_rezerve_provider_app/core/push/push_token_source.dart';
...
/// revokes the token THIS device registered, so a handset handed to someone else stops receiving the salon's
/// notices.
