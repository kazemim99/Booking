...
Automated integration tests for AsanRezerve frontend features.
...
Create a `.env.test` file in the `asanrezerve-frontend` directory:
    ...
    steps:
      ...
      - name: Start Backend Services
        run: |
          ...
          cd ../../UserManagement/AsanRezerve.UserManagement.API
          dotnet run --launch-profile http &
...
- [AsanRezerve API Documentation](../../../API_DOCUMENTATION.md)
