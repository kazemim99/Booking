...
public sealed class RegisterIndependentIndividualCommandValidator : AbstractValidator<RegisterIndependentIndividualCommand>
{
    public RegisterIndependentIndividualCommandValidator()
    {
