...
//namespace AsanRezerve.ServiceCatalog.Application.Commands.Provider.UpdateBusinessInfo;
...
//            request.Description, provider.Profile.ProfileImageUrl,provider.Profile.LogoUrl);
