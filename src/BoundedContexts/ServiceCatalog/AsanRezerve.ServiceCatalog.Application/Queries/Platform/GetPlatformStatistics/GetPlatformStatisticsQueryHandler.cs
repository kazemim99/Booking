// ========================================
// AsanRezerve.ServiceCatalog.Application/Queries/Platform/GetPlatformStatistics/GetPlatformStatisticsQueryHandler.cs
// ========================================
        ...
        : IQueryHandler<GetPlatformStatisticsQuery, PlatformStatisticsViewModel>
    {
            ...
            CancellationToken cancellationToken)
        {
            ...
            try
            {
                ...
                var allServices = new List<AsanRezerve.ServiceCatalog.Domain.Aggregates.Service>();
