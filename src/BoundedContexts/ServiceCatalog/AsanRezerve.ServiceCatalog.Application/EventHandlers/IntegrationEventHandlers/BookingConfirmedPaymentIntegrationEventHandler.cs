// ========================================
// AsanRezerve.ServiceCatalog.Application/EventHandlers/IntegrationEventHandlers/BookingConfirmedPaymentIntegrationEventHandler.cs
// ========================================
...
namespace AsanRezerve.ServiceCatalog.Application.EventHandlers.IntegrationEventHandlers
{
    ...
    public sealed class BookingConfirmedPaymentIntegrationEventHandler : IIntegrationEventHandler<BookingConfirmedIntegrationEvent>
    {
        ...
        public async Task HandleAsync(BookingConfirmedIntegrationEvent integrationEvent, CancellationToken cancellationToken)
        {
            ...
            var bookingId = AsanRezerve.ServiceCatalog.Domain.ValueObjects.BookingId.From(integrationEvent.BookingId);
