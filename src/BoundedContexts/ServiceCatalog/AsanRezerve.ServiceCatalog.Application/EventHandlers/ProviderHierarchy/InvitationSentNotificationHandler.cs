// ========================================
// AsanRezerve.ServiceCatalog.Application/EventHandlers/ProviderHierarchy/InvitationSentNotificationHandler.cs
// ========================================
...
namespace AsanRezerve.ServiceCatalog.Application.EventHandlers.ProviderHierarchy
{
    /// <summary>
    ...
    public sealed class InvitationSentNotificationHandler : IDomainEventHandler<InvitationSentEvent>
    {
        ...
        public async Task HandleAsync(InvitationSentEvent domainEvent, CancellationToken cancellationToken = default)
        {
            try
            {
                ...
                var baseUrl = _configuration["App:BaseUrl"] ?? "https://asanrezerve.ir";
