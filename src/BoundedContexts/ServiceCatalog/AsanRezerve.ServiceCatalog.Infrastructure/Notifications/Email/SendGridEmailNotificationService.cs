// ========================================
// AsanRezerve.ServiceCatalog.Infrastructure/Notifications/Email/SendGridEmailNotificationService.cs
// ========================================
...
namespace AsanRezerve.ServiceCatalog.Infrastructure.Notifications.Email
{
    /// <summary>
    ...
    public sealed class SendGridEmailNotificationService : IEmailNotificationService
    {
            ...
            ILogger<SendGridEmailNotificationService> logger)
        {
            ...
            _logger = logger;
            _fromEmail = configuration["SendGrid:FromEmail"] ?? "noreply@asanrezerve.com";
            _fromName = configuration["SendGrid:FromName"] ?? "AsanRezerve";
        }
