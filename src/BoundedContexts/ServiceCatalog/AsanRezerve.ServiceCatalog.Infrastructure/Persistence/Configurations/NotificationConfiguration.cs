// ========================================
// AsanRezerve.ServiceCatalog.Infrastructure/Persistence/Configurations/NotificationConfiguration.cs
// ========================================
using AsanRezerve.ServiceCatalog.Domain.Aggregates.NotificationAggregate;
using AsanRezerve.ServiceCatalog.Domain.Aggregates.NotificationAggregate.Entities;
    ...
    public sealed class NotificationConfiguration : IEntityTypeConfiguration<Notification>
    {
        public void Configure(EntityTypeBuilder<Notification> builder)
        {
            ...
            builder.OwnsMany(n => n.DeliveryAttempts, attempts =>
            {
                ...
                // The DeliveryAttempt Id is generated by the domain (Guid.NewGuid()), not by the store. Without
                // ValueGeneratedNever, EF's graph-attach heuristic marks a newly-recorded attempt on an
                // already-loaded Notification as Modified, producing a phantom UPDATE that affects 0 rows →
                // DbUpdateConcurrencyException, breaking delivery-attempt recording. See PaymentConfiguration/Transactions.
                attempts.Property(a => a.Id)
                    .ValueGeneratedNever();
