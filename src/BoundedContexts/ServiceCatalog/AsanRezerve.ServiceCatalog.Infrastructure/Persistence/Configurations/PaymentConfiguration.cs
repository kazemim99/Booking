// ========================================
// AsanRezerve.ServiceCatalog.Infrastructure/Persistence/Configurations/PaymentConfiguration.cs
// ========================================
    ...
    public sealed class PaymentConfiguration : IEntityTypeConfiguration<Payment>
    {
        public void Configure(EntityTypeBuilder<Payment> builder)
        {
            ...
            builder.OwnsMany(p => p.Transactions, transactions =>
            {
                ...
                // The Transaction Id is generated by the domain (Guid.NewGuid() in the constructor), NOT by the
                // store. Without ValueGeneratedNever, EF's graph-attach heuristic ("key is set ⇒ entity already
                // exists") marks a newly-added Transaction on an already-loaded Payment as Modified, emitting a
                // phantom UPDATE that affects 0 rows → DbUpdateConcurrencyException on every verify/capture/refund.
                transactions.Property(t => t.Id)
                    .ValueGeneratedNever();
