// ========================================
// AsanRezerve.ServiceCatalog.Infrastructure/Persistence/Seeders/NotificationTemplateSeeder.cs
// ========================================
...
<body>
    <div class=""container"">
        ...
        <div class=""footer"">
            <p>Thank you for choosing AsanRezerve!</p>
            <p>Questions? Contact us at support@asanrezerve.com</p>
        </div>
    </div>
</body>
</html>",
...
Thank you for choosing AsanRezerve!");
...
<body style=""font-family: Arial, sans-serif; line-height: 1.6; color: #333;"">
    <div style=""max-width: 600px; margin: 0 auto; padding: 20px;"">
        ...
        private NotificationTemplate CreateWelcomeEmailTemplate()
        {
            ...
            template.SetEmailTemplate(
                subject: "Welcome to AsanRezerve, {{FirstName}}!",
                bodyHtml: @"
<!DOCTYPE html>
<html>
<body style=""font-family: Arial, sans-serif; line-height: 1.6; color: #333;"">
    <div style=""max-width: 600px; margin: 0 auto; padding: 20px;"">
        <h1 style=""color: #4CAF50; text-align: center;"">Welcome to AsanRezerve!</h1>
        <p>Hi {{FirstName}},</p>
        <p>Thank you for joining AsanRezerve! We're excited to have you on board.</p>

        <p>With AsanRezerve, you can:</p>
        <ul>
...
<body style=""font-family: Arial, sans-serif; line-height: 1.6; color: #333;"">
    <div style=""max-width: 600px; margin: 0 auto; padding: 20px;"">
        ...
        <p>Hi {{FirstName}},</p>
        <p>Please verify your email address to activate your AsanRezerve account.</p>
        ...
        private NotificationTemplate CreatePasswordResetTemplate()
        {
            ...
            template.SetEmailTemplate(
                subject: "Reset your AsanRezerve password",
                bodyHtml: @"
<!DOCTYPE html>
<html>
<body style=""font-family: Arial, sans-serif; line-height: 1.6; color: #333;"">
    <div style=""max-width: 600px; margin: 0 auto; padding: 20px;"">
        ...
        private NotificationTemplate CreatePhoneVerificationTemplate()
        {
            ...
            template.SetSmsTemplate(
                "Your AsanRezerve verification code is: {{OtpCode}}. Valid for {{ValidityMinutes}} minutes. Do not share this code.");
        ...
        private NotificationTemplate CreateAccountDeactivatedTemplate()
        {
            ...
            template.SetEmailTemplate(
                subject: "Your AsanRezerve account has been deactivated",
                bodyHtml: @"
<!DOCTYPE html>
<html>
<body style=""font-family: Arial, sans-serif; line-height: 1.6; color: #333;"">
    <div style=""max-width: 600px; margin: 0 auto; padding: 20px;"">
        ...
        <p>Hi {{FirstName}},</p>
        <p>Your AsanRezerve account has been deactivated as requested.</p>
