...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AsanRezerve.ServiceCatalog.Domain.Entities.ServiceOption", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AsanRezerve.ServiceCatalog.Domain.Entities.ServiceOption", b =>
                {
                    b.HasOne("AsanRezerve.ServiceCatalog.Domain.Aggregates.Service", null)
                        .WithMany("Options")
                        .HasForeignKey("ServiceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("AsanRezerve.ServiceCatalog.Domain.ValueObjects.Price", "AdditionalPrice", b1 =>
                        {
