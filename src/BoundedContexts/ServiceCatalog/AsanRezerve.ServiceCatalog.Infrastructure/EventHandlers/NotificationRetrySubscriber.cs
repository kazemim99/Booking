// ========================================
// AsanRezerve.ServiceCatalog.Infrastructure/EventHandlers/NotificationRetrySubscriber.cs
// ========================================
...
namespace AsanRezerve.ServiceCatalog.Infrastructure.EventHandlers;
...
public sealed class NotificationRetrySubscriber : ICapSubscribe
{
    ...
    [CapSubscribe("asanrezerve.servicecatalog.notificationretryrequested")]
