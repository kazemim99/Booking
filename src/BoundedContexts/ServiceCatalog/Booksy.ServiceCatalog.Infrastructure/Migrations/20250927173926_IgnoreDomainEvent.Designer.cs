...
namespace Booksy.ServiceCatalog.Infrastructure.Migrations
{
    ...
    [Migration("20250927173926_IgnoreDomainEvent")]
    partial class IgnoreDomainEvent
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Booksy.ServiceCatalog.Domain.Aggregates.Service", b =>
                {
                    ...
                    b.Property<string>("QualifiedStaff")
                        .IsRequired()
                        .HasColumnType("text")
                    ...
                    b.OwnsMany("Booksy.ServiceCatalog.Domain.Entities.PriceTier", "PriceTiers", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("uuid")
                                .HasColumnName("PriceTierId");

                            b1.Property<Dictionary<string, string>>("Attributes")
                                .IsRequired()
                                .ValueGeneratedOnAdd()
                                .HasColumnType("jsonb")
                                .HasDefaultValueSql("'{}'::jsonb");
                            ...
                            b1.OwnsOne("Booksy.ServiceCatalog.Domain.ValueObjects.Price", "Price", b2 =>
                                {
                                    ...
                                    b2.ToTable("PriceTiers", "ServiceCatalog");
