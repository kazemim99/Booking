...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Booksy.ServiceCatalog.Domain.Entities.PriceTier", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("PriceTiers", "ServiceCatalog");
                });
                    ...
                    b.OwnsOne("Booksy.ServiceCatalog.Domain.Entities.BusinessProfile", "Profile", b1 =>
                        {
                            ...
                            b1.Property<Dictionary<string, string>>("SocialMedia")
                                .IsRequired()
                                .HasColumnType("hstore");
            ...
            modelBuilder.Entity("Booksy.ServiceCatalog.Domain.Entities.PriceTier", b =>
                {
                    ...
                    b.OwnsOne("Booksy.ServiceCatalog.Domain.ValueObjects.Price", "Price", b1 =>
                        {
                            b1.Property<Guid>("PriceTierId")
                                .HasColumnType("uuid");
                            ...
                            b1.HasKey("PriceTierId");

                            b1.ToTable("PriceTiers", "ServiceCatalog");
