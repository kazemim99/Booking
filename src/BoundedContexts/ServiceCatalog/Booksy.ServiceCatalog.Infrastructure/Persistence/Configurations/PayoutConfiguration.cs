...
namespace Booksy.ServiceCatalog.Infrastructure.Persistence.Configurations
{
    public sealed class PayoutConfiguration : IEntityTypeConfiguration<Payout>
    {
        public void Configure(EntityTypeBuilder<Payout> builder)
        {
            ...
            // PaymentIds (JSON array) - Configure as shadow property to avoid EF trying to materialize PaymentId
            builder.Property<string>("PaymentIdsJson")
                .HasColumnName("PaymentIds")
                .HasColumnType("jsonb")
                .IsRequired(false);

            // Ignore both the public property and backing field for PaymentIds collection
            builder.Ignore(p => p.PaymentIds);
            builder.Ignore("_paymentIds");
