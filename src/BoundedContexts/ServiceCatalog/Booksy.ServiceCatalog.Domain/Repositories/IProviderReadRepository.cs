...
namespace Booksy.ServiceCatalog.Domain.Repositories
{
    public interface IProviderReadRepository : IReadRepository<Provider, ProviderId>
    {
        ...
        Task<IReadOnlyList<Provider>> GetByTypeAsync(BusinessSize type, CancellationToken cancellationToken = default);
        ...
        Task<PagedResult<Provider>> GetPaginatedAsync(int pageNumber, int pageSize, ProviderStatus? status = null, BusinessSize? type = null, CancellationToken cancellationToken = default);
