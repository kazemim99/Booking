...
using AsanRezerve.ServiceCatalog.Api.Extensions;
...
namespace AsanRezerve.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddAsanRezerveRateLimiting(Configuration);
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IApiVersionDescriptionProvider provider)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                // Map SignalR hubs
                endpoints.MapHub<AsanRezerve.ServiceCatalog.Infrastructure.Hubs.NotificationHub>("/hubs/notifications");
            });


            // Seeding is opt-out by configuration, not by the environment's NAME — see the same change in
            // AsanRezerve.Host/Program.cs. Development still seeds by default.
