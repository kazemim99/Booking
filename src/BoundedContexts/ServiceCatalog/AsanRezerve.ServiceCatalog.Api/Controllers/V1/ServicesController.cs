...
using AsanRezerve.ServiceCatalog.Application.Queries.Service.GetServicesByStatus;
using AsanRezerve.ServiceCatalog.Application.Queries.Service.GetPopularServices;
using AsanRezerve.ServiceCatalog.Api.Models.Responses;
...
using AsanRezerve.ServiceCatalog.Application.Queries.Service.GetQualifiedStaff;
...
public class ServicesController : ControllerBase
{
    ...
    /// <see cref="AsanRezerve.UserManagement.Infrastructure"/>'s token service emits — it writes
