...
// ========================================
using AsanRezerve.Infrastructure.Monitoring.HealthChecks;
using AsanRezerve.Infrastructure.Monitoring.Metrics;
using AsanRezerve.Infrastructure.Monitoring.Telemetry;
...
namespace AsanRezerve.Infrastructure.Monitoring;
...
public static class MonitoringExtensions
{
        ...
        IConfiguration configuration)
    {
        ...
        {
            var serviceName = configuration["Monitoring:OpenTelemetry:ServiceName"] ?? "AsanRezerve";
