...
The `DatabaseExtensions.MigrateAndSeedDatabaseAsync` method provides a unified way to handle database migrations and seeding across all bounded contexts in the AsanRezerve application.
