// AsanRezerve.API/Middleware/ExceptionHandlingMiddleware.cs
using System.Net;
...
using ApplicationException = AsanRezerve.Core.Application.Exceptions.ApplicationException;

namespace AsanRezerve.API.Middleware;
...
public partial class ExceptionHandlingMiddleware
{
    ...
    private async Task HandleExceptionAsync(HttpContext context, Exception exception)
    {
        ...
        switch (exception)
        {
            ...
            case AsanRezerve.Core.Application.Exceptions.TooManyRequestsException tooManyEx:
            ...
            case AsanRezerve.Core.Application.Exceptions.IdempotencyConflictException:
                response.StatusCode = (int)HttpStatusCode.Conflict;
                errorResponse = new ApiErrorResult(
            ...
            case Exception ex when ex.GetType().FullName == "AsanRezerve.ServiceCatalog.Application.Exceptions.ValidationException":
                response.StatusCode = (int)HttpStatusCode.BadRequest;
