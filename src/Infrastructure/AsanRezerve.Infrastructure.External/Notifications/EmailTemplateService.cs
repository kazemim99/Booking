            ...
            return new Dictionary<string, EmailTemplate>
            {
                [EmailTemplate.Templates.Welcome] = new EmailTemplate
                {
                    ...
                    HtmlBody = @"
                        ...
                        <p>Best regards,<br>The AsanRezerve Team</p>",
                    PlainTextBody = @"
                        Welcome to AsanRezerve!
                        Hi {{FirstName}},
                        Thank you for joining AsanRezerve. To activate your account, visit:
                        {{ActivationUrl}}
                        Best regards,
                        The AsanRezerve Team"
                },
