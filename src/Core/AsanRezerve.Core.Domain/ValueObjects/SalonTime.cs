namespace AsanRezerve.Core.Domain.ValueObjects
{
    /// <summary>
    ...
    ///
    /// <para><b>Why a fixed offset.</b> AsanRezerve operates in Iran, which stopped observing daylight saving time in
