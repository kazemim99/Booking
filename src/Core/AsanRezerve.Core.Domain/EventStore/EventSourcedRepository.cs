// AsanRezerve.SharedKernel.Infrastructure.EventStore/EventSourcedRepository.cs
using AsanRezerve.Core.Domain.Abstractions;
using AsanRezerve.Core.Domain.Domain.Abstractions;
using AsanRezerve.Core.Domain.Domain.Exceptions;
using AsanRezerve.Core.Domain.Infrastructure.Persistence;
using Microsoft.Extensions.Logging;
using System.Text.Json;

namespace AsanRezerve.Core.Domain.EventStore;
