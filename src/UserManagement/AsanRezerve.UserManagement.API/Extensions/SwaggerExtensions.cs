...
namespace AsanRezerve.UserManagement.API.Extensions;
...
public static class SwaggerExtensions
{
        ...
        IConfiguration configuration)
    {
        ...
        services.AddSwaggerGen(options =>
        {
            ...
            {
                Title = "AsanRezerve User Management API",
                Version = "v1",
                Description = "API for managing users in the AsanRezerve platform",
        ...
        IApiVersionDescriptionProvider provider)
    {
        ...
        app.UseSwaggerUI(options =>
        {
            ...
            options.DocumentTitle = "AsanRezerve User Management API";
