// ========================================
// AsanRezerve.UserManagement.Domain/Aggregates/UserAggregate/User.cs
// ========================================
...
using AsanRezerve.UserManagement.Domain.Events;
using AsanRezerve.UserManagement.Domain.Exceptions;
using static System.Runtime.InteropServices.JavaScript.JSType;

namespace AsanRezerve.UserManagement.Domain.Aggregates
{
    /// <summary>
    ...
    public sealed class User : AggregateRoot<UserId>, IAuditableEntity
    {
            ...
            string lastName)
        {
            var user = new User
            {
                ...
                Email = Email.Create($"{phoneNumber.Value.Replace("+0 ", "a")}@temp.asanrezerve.com"), // Temporary email
