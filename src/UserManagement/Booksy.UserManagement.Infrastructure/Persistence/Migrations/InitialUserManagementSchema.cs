// ========================================
// Booksy.UserManagement.Infrastructure/Persistence/Migrations/InitialUserManagementSchema.cs
// ========================================
using System;
...
{
    /// <summary>
    /// Initial migration for User Management schema
    /// To generate: dotnet ef migrations add InitialUserManagementSchema -c UserManagementDbContext
    /// To apply: dotnet ef database update -c UserManagementDbContext
    /// </summary>
    public partial class InitialUserManagementSchema : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            // Create AuthenticationSessions table
            migrationBuilder.CreateTable(
            ...
            // Create EventStore table (for event sourcing)
            migrationBuilder.CreateTable(
                name: "event_store",
                schema: "user_management",
                columns: table => new
        ...
        private void CreateIndexes(MigrationBuilder migrationBuilder)
        {
            ...
            // AuthenticationSessions indexes
            migrationBuilder.CreateIndex(
            ...
            migrationBuilder.CreateIndex(
                name: "ix_event_store_correlation_id",
                schema: "user_management",
                table: "event_store",
