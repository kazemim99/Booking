// ========================================
// AsanRezerve.UserManagement.Application/EventHandlers/IntegrationEventHandlers/ProviderRegisteredEventSubscriber.cs
// ========================================
...
namespace AsanRezerve.UserManagement.Application.EventHandlers.IntegrationEventHandlers;
...
public sealed class ProviderRegisteredEventSubscriber : ICapSubscribe
{
    ...
    /// Topic: asanrezerve.servicecatalog.providerregistered
    /// Group: asanrezerve.usermanagement (defined in CAP configuration)
    /// </summary>
    [CapSubscribe("asanrezerve.servicecatalog.providerregistered")]
