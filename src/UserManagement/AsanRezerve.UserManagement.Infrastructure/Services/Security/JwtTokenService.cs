...
namespace AsanRezerve.UserManagement.Infrastructure.Services.Security
{
    public class JwtTokenService : IJwtTokenService
    {
        ...
        public JwtTokenService(IConfiguration configuration)
        {
            ...
            _issuer = _configuration["Jwt:Issuer"] ?? "AsanRezerve";
            _audience = _configuration["Jwt:Audience"] ?? "AsanRezerve.Users";
