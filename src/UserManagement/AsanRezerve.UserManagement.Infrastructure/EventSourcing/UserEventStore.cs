...
using AsanRezerve.UserManagement.Infrastructure.Persistence.Configurations;
...
namespace AsanRezerve.UserManagement.Infrastructure.EventSourcing
{
    public class UserEventStore : IUserEventStore
    {
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            {
                var eventType = Type.GetType($"AsanRezerve.UserManagement.Domain.Events.{storedEvent.EventType}");
                if (eventType == null)
                {
