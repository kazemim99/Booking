...
namespace AsanRezerve.UserManagement.Infrastructure.Migrations
{
    ...
    [Migration("20260104192610_AddCustomerRecentlyVisitedProviders")]
    partial class AddCustomerRecentlyVisitedProviders
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AsanRezerve.Infrastructure.Core.Persistence.EventStore.StoredEvent", b =>
                {
            ...
            modelBuilder.Entity("AsanRezerve.UserManagement.Domain.Aggregates.CustomerAggregate.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("AsanRezerve.UserManagement.Domain.Aggregates.PhoneVerificationAggregate.PhoneVerification", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("AsanRezerve.UserManagement.Domain.Aggregates.User", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("AsanRezerve.UserManagement.Domain.Entities.UserProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("AsanRezerve.UserManagement.Domain.Entities.UserRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("AsanRezerve.UserManagement.Domain.ReadModels.CustomerBookingHistoryEntry", b =>
                {
            ...
            modelBuilder.Entity("AsanRezerve.UserManagement.Domain.Aggregates.CustomerAggregate.Customer", b =>
                {
                    b.OwnsMany("AsanRezerve.UserManagement.Domain.Entities.CustomerFavoriteProvider", "FavoriteProviders", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("uuid")
                    ...
                    b.OwnsMany("AsanRezerve.UserManagement.Domain.Entities.CustomerRecentlyVisitedProvider", "RecentlyVisited", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("uuid")
                    ...
                    b.OwnsOne("AsanRezerve.UserManagement.Domain.ValueObjects.NotificationPreferences", "NotificationPreferences", b1 =>
                        {
                            b1.Property<Guid>("CustomerId")
                                .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AsanRezerve.UserManagement.Domain.Aggregates.User", b =>
                {
                    b.OwnsOne("AsanRezerve.Core.Domain.ValueObjects.Email", "Email", b1 =>
                        {
                    ...
                    b.OwnsMany("AsanRezerve.UserManagement.Domain.Entities.AuthenticationSession", "ActiveSessions", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("uuid");
                    ...
                    b.OwnsMany("AsanRezerve.UserManagement.Domain.Entities.LoginAttempt", "RecentLoginAttempts", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("uuid")
                    ...
                    b.OwnsMany("AsanRezerve.UserManagement.Domain.Entities.RefreshToken", "RefreshTokens", b1 =>
                        {
                            b1.Property<Guid>("Id")
                                .ValueGeneratedOnAdd()
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("AsanRezerve.UserManagement.Domain.ValueObjects.ActivationToken", "ActivationToken", b1 =>
                        {
                            b1.Property<Guid>("UserId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("AsanRezerve.UserManagement.Domain.ValueObjects.HashedPassword", "Password", b1 =>
                        {
                            b1.Property<Guid>("UserId")
                                .HasColumnType("uuid");
                    ...
                    b.OwnsOne("AsanRezerve.UserManagement.Domain.ValueObjects.PasswordResetToken", "PasswordResetToken", b1 =>
                        {
                            b1.Property<Guid>("UserId")
                                .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AsanRezerve.UserManagement.Domain.Entities.UserProfile", b =>
                {
                    b.HasOne("AsanRezerve.UserManagement.Domain.Aggregates.User", null)
                        .WithOne("Profile")
                        .HasForeignKey("AsanRezerve.UserManagement.Domain.Entities.UserProfile", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("AsanRezerve.Core.Domain.ValueObjects.Address", "Address", b1 =>
                        {
                    ...
                    b.OwnsOne("AsanRezerve.Core.Domain.ValueObjects.PhoneNumber", "AlternatePhoneNumber", b1 =>
                        {
                            b1.Property<Guid>("UserProfileId")
                                .HasColumnType("uuid");
