...
dotnet ef database update --startup-project ../AsanRezerve.UserManagement.API --context UserManagementDbContext
```

### Rollback:
```bash
dotnet ef database update FixUserProfileCustomerIdConflict --startup-project ../AsanRezerve.UserManagement.API --context UserManagementDbContext
```
