// ========================================
// AsanRezerve.UserManagement.Infrastructure/Testing/Builders/UserBuilder.cs
// ========================================
...
namespace AsanRezerve.UserManagement.Infrastructure.Testing.Builders
{
    /// <summary>
    ...
    public class UserBuilder
    {
        ...
        /// </summary>
        public static User BuildAdmin(string email = "admin@asanrezerve.com")
        {
            return Create()
                .WithEmail(email)
