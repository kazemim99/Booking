...
/// <c>AsanRezerve.Host.CompositionTests</c> can assert the container resolves this exact type.
/// </remarks>
public sealed class InProcessTokenService : ITokenService
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var userType = Enum.TryParse<AsanRezerve.UserManagement.Domain.Enums.UserType>(user.Type, out var parsed)
            ? parsed
            : AsanRezerve.UserManagement.Domain.Enums.UserType.Customer;
        ...
        var accessToken = _jwtTokenService.GenerateAccessToken(
            AsanRezerve.Core.Domain.ValueObjects.UserId.From(user.UserId),
            userType,
            AsanRezerve.Core.Domain.ValueObjects.Email.Create(user.Email ?? string.Empty),
