namespace Booksy.Host;

/// <summary>
/// Marker type used by integration tests to locate the <c>Booksy.Host</c> assembly, so
...
///
/// <para><b>Why a marker instead of <c>Program</c>.</b> <c>Booksy.Host</c> and
/// <c>Booksy.UserManagement.API</c> both declare a global <c>Program</c>, so naming it directly is
