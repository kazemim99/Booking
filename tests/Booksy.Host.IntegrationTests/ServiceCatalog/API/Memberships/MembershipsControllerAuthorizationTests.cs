...
/// threw UnauthorizedAccessException, which Booksy.API's ExceptionHandlingMiddleware maps to
...
{
    public MembershipsControllerAuthorizationTests(BooksyHostFactory factory)
        : base(factory) { }
