...
{
    private static readonly Assembly ApplicationAssembly = typeof(AsanRezerve.ServiceCatalog.Application.Commands.Payment.RefundPayment.RefundPaymentCommand).Assembly;
