...
namespace AsanRezerve.ServiceCatalog.Application.UnitTests.Commands.ProviderStaff;
...
public class DeactivateProviderStaffCommandHandlerTests
{
    ...
    private DeactivateProviderStaffCommandHandler CreateHandler(Guid callerId)
    {
        ...
        return new DeactivateProviderStaffCommandHandler(
            ...
            Substitute.For<AsanRezerve.ServiceCatalog.Application.Services.Notifications.INotificationRaiser>(),
