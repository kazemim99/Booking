...
using RegTimeSlot = AsanRezerve.ServiceCatalog.Application.Commands.Provider.Registration.TimeSlotDto;
using RegBreak = AsanRezerve.ServiceCatalog.Application.Commands.Provider.Registration.BreakTimeDto;
using FullService = AsanRezerve.ServiceCatalog.Application.Commands.Provider.RegisterProviderFull.ServiceDto;

namespace AsanRezerve.ServiceCatalog.Application.UnitTests.Commands.ProviderRegistration;
