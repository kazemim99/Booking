...
Scenario: Successfully refund full amount
    Given a Behpardakht completed Behpardakht payment exists with:
        ...
        | CardPan        | 6104****1234    |
    When I refund via Behpardakht 500000 Rials with reason "Full refund requested"
    Then the response status code should be 200
    And the Behpardakht refunded amount should be 500000
...
Scenario: Successfully refund partial amount
    Given a Behpardakht completed Behpardakht payment exists with:
        ...
        | CardPan        | 6104****5678    |
    When I refund via Behpardakht 200000 Rials with reason "Partial service cancellation"
    Then the response status code should be 200
    And the Behpardakht refunded amount should be 200000
...
Scenario: Refund multiple partial amounts
    ...
    When I refund via Behpardakht 250000 Rials with reason "Additional refund"
    Then the response status code should be 200
...
Scenario: Refund with specific refund reason codes
    Given a Behpardakht completed Behpardakht payment exists with:
        ...
        | CardPan        | 6104****6789           |
    When I refund via Behpardakht 350000 Rials with reason "Customer dissatisfaction"
    Then the response status code should be 200
...
Scenario: Handle Behpardakht refund gateway error
    ...
    When I refund via Behpardakht 450000 Rials with reason "Gateway error test"
