// ========================================
// AsanRezerve.Tests.Commons/PostgresTestContainerFixture.cs
// ========================================
using Npgsql;
using Testcontainers.PostgreSql;
using Xunit;

namespace AsanRezerve.Tests.Common.Fixtures;
...
public sealed class PostgresTestContainerFixture : IAsyncLifetime
{
    ...
    public async Task InitializeAsync()
    {
        ...
        _databaseName = $"asanrezerve_test_{Guid.NewGuid():N}";
