...
namespace Booksy.UserManagement.Application.UnitTests.Services;
...
public class JwtTokenServiceMembershipClaimsTests
{
    private static JwtTokenService CreateService()
    {
        var configuration = new ConfigurationBuilder()
            ...
            {
                ["Jwt:Issuer"] = "Booksy.Tests",
                ["Jwt:Audience"] = "Booksy.Tests.Users",
    ...
    private static string GenerateToken(
        ...
        service.GenerateAccessToken(
            ...
            email: Email.Create("owner@booksy.test"),
