...
namespace AsanRezerve.UserManagement.IntegrationTests.Services;
...
///
/// <para>Takes its scopes from the shared <see cref="AsanRezerveHostFactory"/>
...
public sealed class PersonProvisioningConcurrencyTests : IAsyncLifetime
{
    ...
    public PersonProvisioningConcurrencyTests(AsanRezerveHostFactory factory)
    {
        _factory = factory;
    }
