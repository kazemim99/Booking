// ========================================
// AsanRezerve.UserManagement.IntegrationTests/UserManagementIntegrationTestBase.cs
// ========================================
...
namespace AsanRezerve.Host.IntegrationTests.UserManagement;
...
///
/// No <c>IClassFixture</c> here: every leaf class instead joins
/// <see cref="AsanRezerveHostTestCollection"/> via <c>[Collection(AsanRezerveHostTestCollection.Name)]</c> —
/// the SAME collection ServiceCatalog tests join, since both now share one
/// <see cref="AsanRezerveHostFactory"/> (docs/TEST_ARCHITECTURE_AUDIT.md Phase 2 slice 4).
/// </summary>
public abstract class UserManagementIntegrationTestBase
    : IntegrationTestBase<UserManagementDbContext>
{
    public UserManagementIntegrationTestBase(AsanRezerveHostFactory factory)
        : base(factory)
    {
    }
