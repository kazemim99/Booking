...
/// <see cref="AsanRezerve.Host.IntegrationTests.Composition.HostCompositionFactory"/> stays separate and
...
/// <c>AsanRezerve.Host.HostEntryPoint</c>).</para>
///
