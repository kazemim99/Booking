...
using AsanRezerve.Host.IntegrationTests.Infrastructure;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.DependencyInjection;
using System.Linq.Expressions;
// This file's bare "Domain.Enums.X" / "Domain.Aggregates.X" references used to resolve through
// C#'s enclosing-namespace lookup: the old namespace (AsanRezerve.ServiceCatalog.IntegrationTests.*)
// had AsanRezerve.ServiceCatalog as an ENCLOSING namespace, which has a nested Domain namespace of its
// own. Moving this file's namespace to AsanRezerve.Host.IntegrationTests.ServiceCatalog (slice 4) broke
...
using Domain = AsanRezerve.ServiceCatalog.Domain;

namespace AsanRezerve.Host.IntegrationTests.ServiceCatalog;
...
{
    public ServiceCatalogIntegrationTestBase(AsanRezerveHostFactory factory)
        : base(factory)
    {
    }
    ...
    public async Task<Guid> CreateAndAuthenticateAsRealUserAsync(
        ...
        global::AsanRezerve.UserManagement.Domain.Enums.UserType type = global::AsanRezerve.UserManagement.Domain.Enums.UserType.Provider)
    {
        // Bare "UserManagement.X" below would resolve to THIS project's own
        // AsanRezerve.Host.IntegrationTests.UserManagement namespace (the base class lives there) rather
        ...
        var userDbContext = Scope.ServiceProvider
            .GetRequiredService<global::AsanRezerve.UserManagement.Infrastructure.Persistence.Context.UserManagementDbContext>();
        ...
        var user = global::AsanRezerve.UserManagement.Domain.Aggregates.User.Register(
            Core.Domain.ValueObjects.Email.Create(email),
            global::AsanRezerve.UserManagement.Domain.ValueObjects.HashedPassword.FromHash("$2a$11$integrationtestplaceholderhash"),
            global::AsanRezerve.UserManagement.Domain.Entities.UserProfile.Create("Test", "Owner"),
            type);
    ...
    {
        base.AuthenticateAsAdmin("admin@asanrezerve.com");
    }
