...
using AddServiceRequest = AsanRezerve.ServiceCatalog.Api.Models.Requests.AddServiceRequest;
...
{
    public ProviderSettingsControllerTests(AsanRezerveHostFactory factory)
        : base(factory)
    {
    }
