...
using System.Net;
using Xunit;
using static AsanRezerve.ServiceCatalog.API.Controllers.V1.ProviderSettingsController;

namespace AsanRezerve.ServiceCatalog.IntegrationTests.API.ProviderSettings;
...
{
    public ProviderSettingsTests(AsanRezerveHostFactory factory) : base(factory)
    {
    }
