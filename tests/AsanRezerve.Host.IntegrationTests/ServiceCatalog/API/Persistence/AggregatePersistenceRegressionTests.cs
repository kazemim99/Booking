...
namespace AsanRezerve.ServiceCatalog.IntegrationTests.API.Persistence;
...
public class AggregatePersistenceRegressionTests : ServiceCatalogIntegrationTestBase
{
    public AggregatePersistenceRegressionTests(
        AsanRezerveHostFactory factory)
        : base(factory)
    {
    }
