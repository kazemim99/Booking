...
using AsanRezerve.Core.Application.Abstractions.Idempotency;
...
public class IdempotencyStoreTests : ServiceCatalogIntegrationTestBase
{
    public IdempotencyStoreTests(AsanRezerveHostFactory factory)
        : base(factory) { }
