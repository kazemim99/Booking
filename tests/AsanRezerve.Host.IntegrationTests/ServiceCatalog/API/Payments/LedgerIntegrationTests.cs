...
using AsanRezerve.ServiceCatalog.Infrastructure.Payments;
...
public class LedgerIntegrationTests : ServiceCatalogIntegrationTestBase
{
    public LedgerIntegrationTests(AsanRezerveHostFactory factory)
        : base(factory) { }
