...
using AsanRezerve.ServiceCatalog.Application.Queries.Payment.GetProviderEarnings;
...
{
    public FinancialControllerTests(AsanRezerveHostFactory factory) : base(factory)
    {
    }
