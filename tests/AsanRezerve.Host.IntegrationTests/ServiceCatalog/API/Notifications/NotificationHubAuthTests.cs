...
namespace AsanRezerve.ServiceCatalog.IntegrationTests.API.Notifications;
...
public class NotificationHubAuthTests : ServiceCatalogIntegrationTestBase
{
    public NotificationHubAuthTests(AsanRezerveHostFactory factory)
        : base(factory) { }
