...
using static AsanRezerve.ServiceCatalog.Application.Commands.Provider.RegisterProviderFull.RegisterProviderFullCommand;

namespace AsanRezerve.ServiceCatalog.IntegrationTests.API.Providers;
...
{
    public ProviderManagementTests(AsanRezerveHostFactory factory) : base(factory)
    {
    }
