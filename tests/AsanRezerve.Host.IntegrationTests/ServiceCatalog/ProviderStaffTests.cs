...
using System.Net;
using Xunit;
using static AsanRezerve.ServiceCatalog.API.Controllers.V1.ProvidersController;

namespace AsanRezerve.ServiceCatalog.IntegrationTests.API.ProviderStaff;
...
{
    public ProviderStaffTests(AsanRezerveHostFactory factory) : base(factory)
    {
    }
