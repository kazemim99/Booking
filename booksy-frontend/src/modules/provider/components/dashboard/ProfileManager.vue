              ...
              >
                <div class="day-row">
                  ...
                  <div class="day-left">
                    ...
                    <span class="day-name">{{ weekDays[index].persian }}</span>
                  ...
                  <div v-if="day.isOpen" class="time-fields">
                    <div class="time-input-group">
                      ...
                      <PersianTimePicker v-model="day.startTime" placeholder="10:00" />
                    </div>
                    <div class="time-input-group">
                      <label class="time-label">ساعت پایان</label>
                      <PersianTimePicker v-model="day.endTime" placeholder="22:00" />
                    </div>
                    <div class="time-input-group">
                      <label class="time-label">استراحت</label>
                      <PersianTimePicker v-model="day.breakTime" placeholder="14:00" />
                    </div>
                    <button
                      type="button"
                      class="copy-btn"
                      @click="copyToAll(index)"
                      title="کپی به همه روزها"
                    >
                      <svg class="btn-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path
...
const copyToAll = (index: number) => {
  const sourceDay = workingHours.value[index]
  workingHours.value = workingHours.value.map(() => ({
